...
st.header("5) Precipitation over time")
st.write("Here we track precipitation to find dry and wet periods")
st.altair_chart(chart_NEW1(df), use_container_width=True)
st.caption("Takeaway: The relationship is noisy but there are some clear clusters we could consider the 'rainy seasons' and some dips we could consider 'dry season'")

st.header("6) Precipitation over Months")
st.write("Here we again track precipitation, on a monthly basis,to find dry and wet periods.")
st.altair_chart(chart_NEW2(df), use_container_width=True)
st.caption("Takeaway: Summer months tend to be dry while winter months get more rain.")
